            ...
            <div class="tab-content" id="reportTabsContent">
              ...
              <div class="tab-pane fade show active" id="citas" role="tabpanel">
                ...
                <div class="text-center mt-4">
                  <a href="vistas/modulos/reportesCitas.php" id="btnPDFCitas" class="btn btn-danger" target="_blank">
              ...
              <div class="tab-pane fade" id="tratamientos" role="tabpanel">
                ...
                <div class="text-center mt-4">
                  <a href="vistas/modulos/reportesTratamientos.php" id="btnPDFTratamientos" class="btn btn-danger" target="_blank">
                    <i class="fa fa-file-pdf-o"></i> Exportar PDF
                  </a>
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="pagos" role="tabpanel">
                ...
                <div class="text-center mt-4">
                  <a href="vistas/modulos/reportesPagos.php" id="btnPDF" class="btn btn-danger" target="_blank">
                    <i class="fa fa-file-pdf-o"></i> Exportar PDF
                  </a>
                </div>
              </div>
